...
if 'test' in sys.argv or 'test_coverage' in sys.argv:
    SOCIALACCOUNT_PROVIDERS = {
        'google': {
            ...
            'APP': {
                'client_id': '1022437018711-g1pqfujfhvuub38qid4duergo9lafmi1.apps.googleusercontent.com',
                'secret': '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',
            },
            'AUTH_PARAMS': {
                'access_type': 'online',
            }
...
GOOGLE_MAPS_API_KEY = 'AIzaSyDanA6l1HRqKXW2s_ILjBelO5iLF9ZShsc'
BASE_COUNTRY = 'US'
